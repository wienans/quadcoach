...
const AddRelatedExercisesDialog = ({ isOpen, onConfirm, alreadyAddedExercises }: EditRelatedExercisesDialogProps): JSX.Element => {
    const [selectedRelatedExercises, setSelectedRelatedExercises] = useState<Exercise[]>([])
        ...
        <Dialog open={isOpen} onClose={() => onClose()}>
            ...
            <DialogContent>
                <ExerciseAutocomplete
                    ...
                    onExercisesSelectedChange={(selectedExercises) => setSelectedRelatedExercises(selectedExercises)}
                    alreadyAddedExercises={alreadyAddedExercises}
                />
            </DialogContent>
            <DialogActions>
                <SoftButton color="secondary" onClick={() => onClose()}>Cancel</SoftButton>
                <SoftButton color="primary" onClick={() => onClose(selectedRelatedExercises)}>Add</SoftButton>
            </DialogActions>
        </Dialog>
    );
}
